      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-background/40 mt-3">📍 Piacenza, Italia</p>
          </div>
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to="/#chi-siamo" className="text-sm text-background/60 hover:text-background transition-colors">Chi Siamo</Link>
        ...
        <div className="border-t border-background/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-background/40">Piacenza, Italia — La community dei motori storici</p>
        </div>
      </div>
    </footer>
  );
